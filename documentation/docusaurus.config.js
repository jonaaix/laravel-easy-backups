...
const config = {
   ...
   baseUrl: isDeploy ? '/laravel-easy-backups/' : '/',

   // GitHub pages deployment config.
   // If you aren't using GitHub pages, you don't need these.
   organizationName: 'jonaaix', // Usually your GitHub org/user name.
   projectName: 'laravel-easy-backups', // Usually your repo name.
      ...
      ({
         ...
         navbar: {
            ...
            items: [
               ...
               {
                  href: 'https://github.com/jonaaix/laravel-easy-backups',
                  label: 'GitHub',
                  position: 'right',
               },
            ],
